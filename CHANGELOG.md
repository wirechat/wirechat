...
### Changed
- Refined outgoing chat message bubbles so messages sent by the authenticated user use normal text weight while incoming messages keep their existing emphasis.
