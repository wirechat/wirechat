    ...
    <header class="">
        <div class="flex  flex-col items-center gap-5">
            ...
            <div class="relative  h-18 w-18 lg:w-24 lg:h-24 overflow-clip rounded-full">
                ...
                <input wire:loading.attr="disabled" id="photo" wire:model="photo" dusk="add_photo_field" type="file" hidden>


                @if (empty($cover_url))
                    {{-- penceil --}}
                    <label  wire:target="photo" wire:loading.class="cursor-not-allowed" wire:loading.class.remove="cursor-pointer"  for="photo"
