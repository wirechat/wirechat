...
<div @class([
    ...
    <div
        ...
        @class([
            ...
            '-mt-1.5' => ! $hasVisibleSenderName,
            'bg-white/50 text-black dark:bg-[color-mix(in_srgb,var(--primary-300)_40%,transparent)] dark:text-white' => $belongsToAuth,
        ...
        <div class="flex flex-row items-start gap-3 px-4 py-3">
            ...
            <div
                @class([
                    ...
                    'text-black dark:text-white' => $belongsToAuth,
