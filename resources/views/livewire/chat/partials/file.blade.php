...
<div dusk="message-file-attachment" class="grid w-72 max-w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 overflow-hidden rounded-xl bg-white/30 p-3 dark:bg-zinc-900/10 sm:w-[26rem]">
    <span class="relative grid h-12 w-12 shrink-0 place-items-center text-zinc-500 dark:text-zinc-500/80">
        ...
        <span dusk="message-file-extension" class="absolute inset-x-0 top-1/2 -translate-y-[12%] text-center text-[8px] font-bold leading-none text-white">
            {{ $fileIconExtension }}
        </span>
    </span>
    ...
    <div class="min-w-0">
        ...
        <p dusk="message-file-meta" class="mt-1 flex items-center gap-1.5 text-xs font-medium uppercase leading-none text-zinc-600 dark:text-zinc-300">
