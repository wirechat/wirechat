      ...
      return <<<'BLADE'
              <div class="w-full h-[calc(100vh_-_0.0rem)] flex  rounded-lg" >
                  ...
                  <div class="m-auto text-center justify-center flex gap-3 flex-col  items-center  col-span-12">
                           ...
                           <h4 class="font-medium p-2 px-3 rounded-full font-semibold dark:bg-gray-800 dark:text-white dark:font-normal">Select a conversation to start messaging</h4>
